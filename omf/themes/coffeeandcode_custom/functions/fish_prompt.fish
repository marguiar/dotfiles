...
set __fish_user_host_separator '@'
...
function fish_prompt --description 'Write out the prompt'
  ...
  if not set -q __fish_user_host_separator
    set -g __fish_user_host_separator (set_color $fish_color_separator)
  end

  echo -s "$__fish_prompt_user" "$USER" "$__fish_user_host_separator" "$__fish_prompt_host" "$__fish_prompt_hostname" "$__fish_prompt_normal" ' ' "$__fish_prompt_cwd" (prompt_pwd) (__fish_git_prompt)
